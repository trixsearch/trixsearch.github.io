...
// no need to import react, it is already imported in the parent component
                    ...
                    <div className="flex items-center gap-2 mt-auto">
                        {socialLinks.map(({ href, icon }, key) => (
                            <a
                                ...
                                href={href}
                                target="_blank"
                                className="w-12 h-12 grid place-items-center ring-inset ring-2 ring-zinc-50/5 rounded-lg transition-[backgroud-color,color] hover:bg-zinc-50 hover:text-zinc-950 active-bg-50/80 reveal-up">
                                {icon}
                            </a>
                        ))}
                    </div>
                </div>
                <form action="https://getform.io/f/bwnnznda" method="POST" className="xl:pl-10 2xl:pl-20">
                    <div className="md:grid md:items-center md:grid-cols-2 md:gap-2 reveal-up">
                        ...
                        <div className="mb-4">
                            ...
                            <input type="email" name="email" id="email"
                                autoComplete="email"
                                required
                                placeholder="inforatme@gmail.com"
                                className="text-field reveal-up" />
                        </div>
                        <div className="mb-4">
